...
if __name__ == "__main__":
    # ADD DATA FROM FILE; no need to worry about duplicates because we are reading from my own file of 40000 unique URLs
    extract_from_file(source_csv="../raw_url_data/raw_url_data.csv", url_index=0, result_index=1, output_csv="url_all_features.csv")